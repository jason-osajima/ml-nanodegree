    ...
    while step * batch_size < training_iters:
        ...
        if step % display_step == 0:
            ...
            print "Iter " + str(step*batch_size) + ", Minibatch Loss= " + \
                  ...
                  "{:.5f}".format(acc)
            cnn_3_step= np.append(cnn_3_step, step*batch_size)
            cnn_3_loss= np.append(cnn_3_loss, loss)
...
h5f = h5py.File('cnn_3_data.h5', 'w')
h5f.create_dataset('cnn_3_loss', data=cnn_3_loss)
h5f.create_dataset('cnn_3_step', data=cnn_3_step)
h5f.create_dataset('cnn_3_cm', data=cnn_3_cm)
h5f.close()